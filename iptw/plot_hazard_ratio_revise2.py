...
def plot_forest_for_drug_DAG_f5yrs(exp_dir, drug_id, drug_id_gpi, drug_name):
    output_dir = r'plots/hazard_ratio_{}/'.format(exp_dir)
    print('output_dir:', output_dir)

    df_fl = pd.read_excel(
        'output/{}/save_cohort_all_loose_f5yrs/LR/results/summarized_IPTW_ATE_LR_finalInfo.xlsx'.format(exp_dir),
        sheet_name=None,
        dtype={'drug': str})

    df_ms = pd.read_excel(
        'output_marketscan/{}/save_cohort_all_loose_f5yrs/LR/results/summarized_IPTW_ATE_LR_finalInfo.xlsx'.format(exp_dir),
        sheet_name=None,
        dtype={'drug': str})
