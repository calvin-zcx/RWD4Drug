...
if __name__ == '__main__':
    """
    only for summarize 5 year followup experiments, all data
    replace or combine original results in appendix 2yr aHR with 5yr aHR
    """
    ...
    # 2023-9-19, 5 yrs followup sensitivity, all data
    cohort_dir_name = 'save_cohort_all_loose_f5yrs'
    model = 'LR'  # 'MLP'  # 'LR' #'LIGHTGBM'  #'LR'  #'LSTM'
    exp_dir = r'output/revise2_f5yrs_all'  # sensitivity analysis
