...
python std3_cohort_build.py --min_patients 20 --min_prescription 4 --exposure_interval 180 --followup 730 --baseline 180 --index_minus_init_min 0 --index_minus_init_max 365 --adrd_minus_index_min 0 --dx_file ${DIAGNOSIS_FILE} --dx_coding ccw --drug_coding rxnorm --save_cohort_all output/save_cohort_all_stringent/ 2>&1 | tee output/save_cohort_all_stringent.log
